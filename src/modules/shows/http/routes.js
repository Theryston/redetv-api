...
router.post(
  "/source",
  [multer(multerConfig).single("file"), AdminMiddleware],
  ShowController.createSource
);
router.post(
  "/source/poster/:source_id",
  [multer(multerConfig).single("file"), AdminMiddleware],
  ShowController.addPosterSource
);
...
router.delete(
  "/season/:season_id",
  AdminMiddleware,
  ShowController.deleteSeason
);

router.post(
  "/logo/data",
  [multer(multerConfig).single("file"), AdminMiddleware],
  InternalController.createLogo
);
...
router.post(
  "/redetv/logo",
  [multer(multerConfig).single("file"), AdminMiddleware],
  InternalController.createRedetvLogo
);
router.put(
  "/redetv/logo/:redetvLogo_id",
  [multer(multerConfig).single("file"), AdminMiddleware],
  InternalController.updateRedetvLogo
);
...
router.post(
  "/news/data",
  [multer(multerConfig).single("file"), AdminMiddleware],
  InternalController.createNewLogo
);
...
router.delete(
  "/news/:logo_id",
  AdminMiddleware,
  InternalController.deleteNewLogo
);
router.put(
  "/news/:logo_id",
  [multer(multerConfig).single("file"), AdminMiddleware],
  InternalController.updateNewLogo
);
